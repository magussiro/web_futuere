...
<head>
    ...
    <link rel="stylesheet" href="css/jquery-ui-blue.min.css">
    <link rel="stylesheet" href="css/index_blue.css">
    <style type="text/css">
    </style>
</head>
<body>
<div id="wrap">
    <!-- <div id="company_logo">富暘理財</div> -->
    <div id="header">
    ...
    <footer>
        <marquee width="75%">123456</marquee>
        <div>
