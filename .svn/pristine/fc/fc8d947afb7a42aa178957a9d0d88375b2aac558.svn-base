...
function ChangeProduct(){
	...
	var url = "http://202.55.227.39/fu//chart?product_code="+ _pcode +"&type=0";
...
function getUrl()
{
	...
	{
		_typev='m1';
		return 'http://202.55.227.39/fu/chart/datalist?chart_type=line&product_code='+$('#pcode').val()+'&type='+_typev.replace('m','');
	}
	else
	{
		return 'http://202.55.227.39/fu/chart/datalist?product_code='+$('#pcode').val()+'&type='+_typev.replace('m','');
	}
