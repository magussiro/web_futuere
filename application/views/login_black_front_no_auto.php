...
<script>
    $( document ).ready(function() {
        ...
        function checkRemAcc(){
            ...
            if(remAcc!==undefined && remPw !== undefined){
        ...
        function checkAcc(){
            ...
            var tmp3 = _getCookie("fu_acc");
            var tmp4 = _getCookie("fu_pw");
        ...
        function doLogin(){
            ...
            obj.success(function (res) {
                ...
                if (res.msg == "success") {
                    ...
                    // console.log(model.rememberAccount);
                    _setCookie("fu_acc",model[0].value,365);
                    _setCookie("fu_pw",model[1].value,365);
                    var remAccCk =  $.grep(model, function(e){ return e.name === "rememberAccount"; });
                    ...
                    var remPwCk =  $.grep(model, function(e){ return e.name === "rememberPass"; });
                ...
                <div class="bg-gray">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input id="account" class="form-control" type="text" name="account" value="<?php if(isset($_COOKIE['fu_acc'])){echo $_COOKIE['fu_acc'];}?>" style="padding:5px;" AutoComplete='Off'>
                        </div>
                        <div class="form-group">
                            <label for="password">密碼</label>
                            <!-- <input type="" class="form-control" id="" placeholder=""> -->
                            <input id="password" class="form-control" type="password" name="password" value="<?php if(isset($_COOKIE['fu_pw'])){echo $_COOKIE['fu_pw'];}?>" style="padding:5px;" AutoComplete='Off'>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="checkbox">
                                    <label>
                                        <input name="rememberAccount" type="checkbox"  <?php if( isset( $_COOKIE['rememberAccount'])&&$_COOKIE['rememberAccount']=="on"){ echo 'checked=\'checked\'';} ?> > 記住用戶名稱
                                    </label>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="checkbox text-right">
                                    <label>
                                        <input name="rememberPass" type="checkbox"  <?php if( isset( $_COOKIE['rememberPass'])&&$_COOKIE['rememberPass']=="on"){ echo 'checked=\'checked\'';} ?>> 記住密碼
                                    </label>
                                </div>
                            </div>
                        </div>
